...
import vivera_service_hero_image from "../../../../../assets/HeroSectionImages/vivera-service-hero-image.png"
...
const ViveraRetainersHero = () => {
 ...
 <div className="mt-6">
        ...
        <Image src={vivera_service_hero_image} alt="" className="xl:absolute right-0 top-0 xl:w-[700px]" />
      </div>
    </div>
  );
};
