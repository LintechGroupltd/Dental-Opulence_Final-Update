...
const people = [
  ...
  { 
    id: 2, 
    name: 'Adam Samar', 
    description: "Adam Samar, Operations Director at a leading specialist medical accountancy firm, has over a decade of expertise in the dental industry. His passion for brand growth and development has been instrumental in building Dental Opulence from the ground up alongside co-founder Dr. Ali Al Hassan. Since the inception of Dental Opulence, Adam's strategic vision and hands-on approach have driven its growth, establishing it as a leading provider of cosmetic and general dentistry. With a robust background in finance, Adam has managed teams of over 30 professionals, overseeing financial operations, streamlining processes, and implementing best practices to drive efficiency and growth. This expertise has been crucial to the development and success of Dental Opulence. Adam prioritizes patient satisfaction and care, building a culture that maintains high standards of clinical excellence. His forward-thinking approach includes implementing the latest technologies and treatment methodologies, ensuring Dental Opulence remains competitive in the dental care landscape. His role encompasses strategic planning, business development, and continuous improvement, navigating the complexities of the dental industry and driving sustainable growth. Through dedication, innovative thinking, and a relentless pursuit of excellence, Adam Samar has transformed Dental Opulence into a distinguished dental practice that sets the standard for quality care and operational efficiency.",
