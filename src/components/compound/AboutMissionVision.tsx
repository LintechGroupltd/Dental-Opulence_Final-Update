...
const AboutMissionVision = () => {
  ...
  const Overlay = ({ children }: { children: ReactNode }) => {
    return <div onClick={()=>setShowOverlay(false)} className="fixed top-0 z-50 bg-transparent md:px-0 px-5 backdrop-blur-sm w-[100vw] h-[100vh] flex items-center justify-center">
      <div onClick={(e) => e.stopPropagation()} className="bg-[#222222] md:w-[30%] aspect-[2/1] flex flex-col items-center text-[#F2F2F2] p-8 justify-center rounded-xl text-l">
  ...
  return (
    <div className="w-full bg-[#100E10]">
     {showOverlay && <Overlay>
      ...
      <div className="md:flex grid grid-cols-1 gap-4 px-4 md:px-24 mb-12">
